...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.chooseFileButton.setGeometry(QtCore.QRect(170, 20, 89, 25))
        self.chooseFileButton.setObjectName("chooseFileButton")
        self.inputFilePath = QtWidgets.QLineEdit(self.centralwidget)
        self.inputFilePath.setGeometry(QtCore.QRect(20, 20, 141, 25))
        ...
        self.convertFileButton.setGeometry(QtCore.QRect(20, 60, 89, 25))
